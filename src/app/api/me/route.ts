...
const patchSchema = z
  .object({
    ...
    cal_q1_shipped: z.string().optional(),
    cal_q2_customers: z.string().optional(),
    cal_q3_didnt_work: z.string().optional(),
    cal_q4_traction: z.string().optional(),
    cal_q5_unknown: z.string().optional(),
